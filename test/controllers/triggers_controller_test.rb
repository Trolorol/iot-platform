...
class TriggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trigger" do
    assert_difference("Trigger.count") do
      post triggers_url, params: { trigger: { name: @trigger.name, type_id: @trigger.type_id } }
    end
  ...
  test "should update trigger" do
    patch trigger_url(@trigger), params: { trigger: { name: @trigger.name, type_id: @trigger.type_id } }
